                        ...
                        <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-remodeling">
                                <div class="portfolio-content h-100 bg-secondary">
                                    <img src="<?= base_url('assets/profile/img/lapak/lapak1.jpg'); ?>" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-construction">
                                <div class="portfolio-content h-100 bg-secondary">
                                    <img src="<?= base_url('assets/profile/img/lapak/lapak2.jpg'); ?>" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <h4>Lapak 2</h4>
                                        <p>Lorem ipsum, dolor sit amet consectetur</p>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-repairs">
                                <div class="portfolio-content h-100 bg-secondary">
                                    <img src="<?= base_url('assets/profile/img/lapak/lapak3.jpg'); ?>" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <h4>Lapak 3</h4>
                                        <p>Lorem ipsum, dolor sit amet consectetur</p>
