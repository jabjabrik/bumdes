                                ...
                                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-remodeling">
                                    <div class="portfolio-content h-100 bg-secondary">
                                        ...
                                        <div class="portfolio-info">
                                            <h4>Harga Sewa : Rp <?= number_format($item->harga, 0, ',', '.') ?>/tahun <br> Satus : <?= $item->nama_penyewa ? 'Telah Disewa' : 'Belum Disewa' ?></h4>
                                            <a href="<?= base_url("file/$item->foto"); ?>" title="<?= "Nama Ruko : $item->nama_properti | harga Rp." . number_format($item->harga, 0, ',', '.') . " | Alamat : $item->alamat_properti | Nama Penyewa : " . ($item->nama_penyewa ?? '(belum disewa)') ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
