    ...
    <div class="app-wrapper">
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Kelola Data Pengurus</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url("file/$item->foto"); ?>" target="_blank">
                                            <img src="<?= base_url("file/$item->foto"); ?>" alt="foto_pengurus" class="img-fluid" width="100">
                                        </a>
                                    </td>
                                    <td>
                                        <?php $params = "[`$item->id_pengurus`, `$item->nama`, `$item->jabatan`]" ?>
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <a href="<?= base_url("pengurus/delete/$item->id_pengurus"); ?>" class="btn btn-outline-danger" onclick="return confirm('Anda yakin ingin menghapus data?')">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 text-capitalize" id="title_form">Form Data Pengurus</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="modal-form" method="POST" autocomplete="off" enctype="multipart/form-data">
                        <div class=" modal-body">
                            <div class="row g-3">
                                <input type="text" name="id_pengurus" id="id_pengurus" hidden>
        ...
        <script>
            ...
            const setForm = (title, data) => {
                const fields = ['id_pengurus', 'nama', 'jabatan'];
                fields.forEach((e, i) => {
                    const element = modal_form.querySelector(`#${e}`);
                    element.value = title == 'insert' ? '' : data[i];
                })

                form.setAttribute('action', `<?= base_url('pengurus') ?>/${title}`)
